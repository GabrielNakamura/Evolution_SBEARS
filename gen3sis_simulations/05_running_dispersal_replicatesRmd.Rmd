...
# Scenario 1 - only dispersion 

This scenario is based on the config file `config_presence.R`
...
# Scenario 2 - same configuration but less species
...
```
# Scenario - high number of communities/high number of species
...
```
# Scenario - high number of communities/low number of species
