##############################################################################
# Function to put data into BioGeoBEARS and rase format.
##############################################################################
...
# Inputs:
# `node_site_matrix`: matrix/array. a matrix or data.frame with the tips(+nodes) 
# presences and absences. Tips(+nodes) in columns, sites in lines.
# `coordinates`: data.frame. an object with the coordinates (lat and long) of 
# all the sites.
# `Nx`: integer. The number of horizontal partitions in the landscape to create 
# the bioregions. Default: 2.
# `Ny`: integer. The number of vertical partitions in the landscape to create 
# the bioregions. Default: 2.
# `output_path`: string. The path to save the data. Default: "./" (local path).
# `filename`: string. A character vector specifying the name of the files of 
# BioGeoBEARS and rase data. Default: "data".
save_rase_BioGeoBEARS_data <- function(node_site_matrix, coordinates, Nx=2, Ny=2, output_path="./", filename="data"){
