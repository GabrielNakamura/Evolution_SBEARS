...
# Based on: workshop_2.R
#
# This script built a node-species community matrix using presence data from a 
# fix number of timesteps. (NOT FINISHED)
...
for(sim in simulation_list){
  ...
  cat("Start processing data of a new simulation.\n")
  ...
  cat("Species presences obtained with success.\n")
  ...
  cat("Tips and nodes from phylogeny renamed with success.\n")
  ...
  cat("Node ocurrences obtained with success.\n")
