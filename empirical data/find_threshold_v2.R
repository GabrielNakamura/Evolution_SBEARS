find_threshold<-function(x,threshold.steps=c(0.4,0.45,0.5,
  ...
  sel=set_diff
  return(list(Maximum_site_probability=max,Removed_sites=sites_off,Correlation_between_steps=cor_steps,Eigenvalues=eigen,Select_threshold=sel))
}